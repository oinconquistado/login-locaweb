...
export const plans: Plans = {
  plan1: {
    ...
    plan_benefits: {
      ...
      title_highlight: " no Estados Unidos",
      benefits: [
  ...
  plan3: {
    ...
    plan_benefits: {
      title: "Seu site em servidores no Estados Unidos",
      benefits: [
        "Servidores em nossos data center americanos;",
        "ASP, ASP.NET 2.0/3.0/3.5/ e 4.0/4.5/4.5.1/4.5.2 (medium trust) ou PHP 5.3, 5.4, 5.5, 5.6 e 7.0;",
        "Usuário ilimitados de FTP para upload ou download;",
        "Ilimitadas contas de e-mails profissionais;",
        "50 subdominios gratuitos;",
      ],
    },
    plan_support: "Suporte 24 horas, 7 dias por semana",
    supported_apps: {
